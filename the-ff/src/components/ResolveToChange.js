...
const ResolveToChange = () => {
	return (
		<section className="bg home-bg2" id="aboutUs">
			<div className="container pd-6">
				<div className="row">
					<div className="col s12 left-align">

					<h2 className="white-text">About Us</h2>
					<p className="col s12 white-text flow-text"> Future Fownders is an immersive program encouraging the development of the entrepreneurial mindset, the cultivation of personal growth, and the establishment of a social network of like-minded aspiring youth entrepreneurs. Our Future Fownders are developed through our in-school programming, workshop series, internship program, mentorship and community outreach initiatives. 
           <br/>
           <br/>
...
export default ResolveToChange;

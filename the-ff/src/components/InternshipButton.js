...
export default class InternshipButton extends React.Component {
  render() {
    return (
      <div  className="btn.brand-blue">
        <form  className="btn.brand-blue" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                ...
                <input type="submit" value="INTERNSHIP" name="submit" title="PayPal - The safer, easier way to pay online!" className=" btn brand-blue"/>
